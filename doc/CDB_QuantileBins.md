Find the breaks for N categories in a numerical column based on the [Quantile bins]. It will ignore NULL values. Below, the quantile method is used to determine color based on the area of the polygons.
